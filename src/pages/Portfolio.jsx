...
const Portfolio = () => {
  ...
  {menuOpen && (
    <div className="flex flex-col overflow-hidden w-60 rounded-bl-2xl bg-black text-white mt-14 absolute right-0 top-0 transition-all duration-300 shadow-lg shadow-[#D4AF37]/40">
      ...
      <section ref={contactRef} className="bg-[#0F0F0F] w-full h-fit flex-col items-center pt-30 grid grid-cols-1 md:grid-cols-2 p-5 md:p-70 gap-0 md:gap-30 text-white/90 pb-10 border-2">
